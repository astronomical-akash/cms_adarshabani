            ...
            <div ref={listRef} className="overflow-y-auto flex-1 p-2 space-y-1 custom-scrollbar">
                {items.map((item, index) => (
                    <div
                        ...
                        className={`group flex items-center justify-between px-3 py-2.5 rounded-md text-sm border-l-[3px] transition-all duration-200 ${selected === item
...
export const HierarchyManager: React.FC = () => {
    ...
    const handleSave = async (updated: CurriculumTree) => {
